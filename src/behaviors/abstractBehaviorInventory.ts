 ...
 */
export abstract class AbstractBehaviorInventory extends StateBehavior {
  ...
  isHelmet (item: Item): boolean {
    ...
    if (id === this.bot.registry.itemsByName.leather_helmet.id) return true
    if (id === this.bot.registry.itemsByName.iron_helmet.id) return true
    if (id === this.bot.registry.itemsByName.golden_helmet.id) return true
    if (id === this.bot.registry.itemsByName.diamond_helmet.id) return true
    if (id === this.bot.registry.itemsByName.turtle_helmet.id) return true
  ...
  isChestplate (item: Item): boolean {
    ...
    if (id === this.bot.registry.itemsByName.leather_chestplate.id) return true
    if (id === this.bot.registry.itemsByName.iron_chestplate.id) return true
    if (id === this.bot.registry.itemsByName.golden_chestplate.id) return true
    if (id === this.bot.registry.itemsByName.diamond_chestplate.id) return true
  ...
  isLeggings (item: Item): boolean {
    ...
    if (id === this.bot.registry.itemsByName.leather_leggings.id) return true
    if (id === this.bot.registry.itemsByName.iron_leggings.id) return true
    if (id === this.bot.registry.itemsByName.golden_leggings.id) return true
    if (id === this.bot.registry.itemsByName.diamond_leggings.id) return true
  ...
  isBoots (item: Item): boolean {
    ...
    if (id === this.bot.registry.itemsByName.leather_boots.id) return true
    if (id === this.bot.registry.itemsByName.iron_boots.id) return true
    if (id === this.bot.registry.itemsByName.golden_boots.id) return true
    if (id === this.bot.registry.itemsByName.diamond_boots.id) return true
  ...
  isOffhandUsable (item: Item): boolean {
    ...
    if (id === this.bot.registry.itemsByName.bow.id) return true
    if (id === this.bot.registry.itemsByName.egg.id) return true
    if (id === this.bot.registry.itemsByName.lingering_potion.id) return true
    if (id === this.bot.registry.itemsByName.snowball.id) return true
    if (id === this.bot.registry.itemsByName.splash_potion.id) return true
    if (id === this.bot.registry.itemsByName.trident.id) return true
    if (id === this.bot.registry.itemsByName.crossbow.id) return true

    if (id === this.bot.registry.itemsByName.bucket.id) return true
    if (id === this.bot.registry.itemsByName.ender_pearl.id) return true
    if (id === this.bot.registry.itemsByName.fishing_rod.id) return true
    if (id === this.bot.registry.itemsByName.flint_and_steel.id) return true
    if (id === this.bot.registry.itemsByName.lead.id) return true
    if (id === this.bot.registry.itemsByName.shears.id) return true
    if (id === this.bot.registry.itemsByName.shield.id) return true
    if (id === this.bot.registry.itemsByName.potion.id) return true
    if (id === this.bot.registry.itemsByName.totem_of_undying.id) return true

    if (id === this.bot.registry.itemsByName.stone_hoe.id) return true
    if (id === this.bot.registry.itemsByName.iron_hoe.id) return true
    if (id === this.bot.registry.itemsByName.golden_hoe.id) return true
    if (id === this.bot.registry.itemsByName.diamond_hoe.id) return true

    if (id === this.bot.registry.itemsByName.stone_shovel.id) return true
    if (id === this.bot.registry.itemsByName.iron_shovel.id) return true
    if (id === this.bot.registry.itemsByName.golden_shovel.id) return true
    if (id === this.bot.registry.itemsByName.diamond_shovel.id) return true

    if (id === this.bot.registry.itemsByName.stone_axe.id) return true
    if (id === this.bot.registry.itemsByName.iron_axe.id) return true
    if (id === this.bot.registry.itemsByName.golden_axe.id) return true
    if (id === this.bot.registry.itemsByName.diamond_axe.id) return true

    if (id === this.bot.registry.itemsByName.map.id) return true
    if (id === this.bot.registry.itemsByName.clock.id) return true
    if (id === this.bot.registry.itemsByName.compass.id) return true

    if (id === this.bot.registry.itemsByName.firework_rocket.id) return true
